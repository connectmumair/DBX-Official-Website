...
$(document).ready(function () {
	const words = ["Innovation", "Engagement", "Impact"];
	let index = 0;
	let letterIndex = 0;
	let direction = 1;
...
$('.platform-slider').slick({
  ...
  $('.platform-wrap-slider1').slick({
	...
	responsive: [
	  ...
	  {
		breakpoint: 480, // or any other mobile breakpoint you prefer
		settings: {
		  slidesToShow: 4,
		  slidesToScroll: 1,
		}
	  ...
	  {
		breakpoint: 340, // or any other mobile breakpoint you prefer
		settings: {
		  slidesToShow: 3,
		  slidesToScroll: 1,
		}

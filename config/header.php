...
<head>
	...
	<title><?php echo isset($pageTitle) ? $pageTitle : "Home | Digital BrainX"; ?></title>
	<link rel="icon" href="<?php echo BASE_URL; ?>assets/img/favicon.png"  sizes="60x60">
			...
			<div class="container d-flex align-items-center justify-content-between">
				<div class="sidebar-menu-logo">
					<a href="index" class="logo-dark">
						<img alt="image" class="img-fluid sidebarlogo" src="<?php echo BASE_URL; ?>assets/img/logomain.png"></a>
				...
				<div class="col-lg-8">
					<div class="sidebar-menu-wrap">
						...
						<li> <a href="<?php echo BASE_URL; ?>about-us">About Us</a> </li>
							<li> <a>Services</a> <span class="dropdown-icon2"><i
										class="bi bi-plus"></i></span>
								<ul class="submenu-list">
							<li><a href="<?php echo BASE_URL;?>social-media-management-services">Social Media Management</a></li>
							<li><a href="<?php echo BASE_URL;?>search-engine-optimization-services">Search Engine Optimization</a></li>
							<li><a href="<?php echo BASE_URL;?>ppc-management-services">Pay Per Click</a></li>
							<li><a href="<?php echo BASE_URL;?>creative-designs-services">Creative Designs</a></li>
							<li> <a href="<?php echo BASE_URL;?>website-development-services">Website Development</a></li>
							<li><a href="<?php echo BASE_URL;?>ecommerce-development-services">eCommerce Development</a></li>
									<li><a href="<?php echo BASE_URL;?>website-maintenance-services">Website Maintenance</a></li>
								</ul>
							</li>
							<li> <a href="<?php echo BASE_URL; ?>case-studies" class="drop-down">Case Studies</a> </li>
							<li> <a href="<?php echo BASE_URL; ?>our-locations" class="drop-down">Our Locations</a> </li>
						</ul>
					</div>
				</div>
				<div class="col-lg-4 d-lg-flex align-items-center sidebarmobmenu">
					<div class="sidebar-contact">
						<div class="getin-touch-area mb-60">
							...
							<ul>
								<li class="single-contact">
									...
									<div class="contact"> <span>Phone</span>
										<h6><a href="tel:+923096044552">+92 309 604 4552</a></h6>
										<h6><a href="tel:+447480322453">+44 748 032 2453</a></h6>
									</div>
								</li>
								<li class="single-contact">
									<div class="icon">
									...
									<div class="contact"> <span>Email Now</span>
										<h6><a href="mailto:info@digitalbrainx.com"><span class="__cf_email__">info@digitalbrainx.com</span></a></h6>
										<h6><a href="mailto:sales@digitalbrainx.com"><span class="__cf_email__">sales@digitalbrainx.com</span></a></h6>
									</div>
								</li>
								<li class="single-contact">
									<div class="icon">
									...
									<div class="contact">
										<h6>Office 4078 182-184 High Street North, East Ham, London E6 2JA. UK</h6>
									</div>
								</li>
							</ul>
						</div>
						<div class="social-link-area">
							...
							<ul class="social-area">
								<li><a href="https://www.facebook.com/digitalbrainx.official"><i class="bi bi-facebook"></i> Facebook</a></li>
								<li><a href="https://www.instagram.com/digitalbrainx.official"><i class="bi bi-instagram"></i> Instagram</a></li>
								<li><a href="https://www.linkedin.com/company/digitalbrainx-official"><i class="bi bi-linkedin"></i> Linkedin</a>
								</li>
								<li><a href="https://x.com/DBX_Agency"><i class="bi bi-twitter"></i> Twitter</a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<header class="header-area style-1">
		<div class="container d-flex flex-nowrap align-items-center justify-content-between">
			<div class="company-logo">
				<a href="index" class="logo-dark"><img alt="image" class="img-fluid logoheader"
						src="<?php echo BASE_URL; ?>assets/img/logomain.png"></a>
				<a href="index" class="logo-light"><img alt="image" class="img-fluid"
						src="<?php echo BASE_URL; ?>assets/img/logo-light.svg"></a>
			</div>
			<div class="main-menu d-lg-flex d-none">
				<ul class="menu-list">
				<li> <a href="<?php echo BASE_URL; ?>">Home</a> </li>
				<li> <a href="<?php echo BASE_URL; ?>about-us">About Us</a> </li>
					<li class="menu-item-has-children"><a class="drop-down">Services</a><i
			...
			<div class="nav-right d-flex jsutify-content-end align-items-center">
				<div class="right-sidebar-and-hotline-area">
					<div class="hotline-area d-xl-flex d-none">
						...
						<div class="content"> <span>Any Question</span>
							<h6><a href="tel:+923096044552">Speak to an Expert</a></h6>
						</div>
					</div>
					...
					<div class="sidebar-button mobile-menu-btn d-none"> <span></span> </div>
				</div>
			</div>
		</div>
	</header>